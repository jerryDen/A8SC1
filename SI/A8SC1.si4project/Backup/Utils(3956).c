...
static char * md5StrTransformold(const char *s, char *d)
{
...
static char * md5StrTransform(const char *file_path, char *md5_str)
{
...
static char * md5FileTransform(const char *fileName, char *d)
{
...
static double getTimestamp(char * timestamp)
{
